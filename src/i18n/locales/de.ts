export default {
  ...
  editor: {
    ...
    cssAreas: {
      ...
      bottom_left: 'Bottom-Leiste · links',
      bottom_center: 'Bottom-Leiste · Mitte',
      bottom_right: 'Bottom-Leiste · rechts',
      bar_sidebar: 'Globale Seitenleiste',
    ...
    bottom: {
      title: 'Bottom-Leiste',
      hint: 'Die Bottom-Leiste hat drei Bereiche — links, Mitte und rechts. In jedem lassen sich im Bearbeitungsmodus Cards einfügen.',
      height: 'Höhe der Leiste (px)',
      heightHint: '40 bis 240.',
    },
    barPlacement: {
  ...
  settings: {
    ...
    barPositionHints: {
      sidebar: 'Links, ab 1024 px sichtbar',
