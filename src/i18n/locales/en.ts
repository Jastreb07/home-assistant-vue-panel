export default {
  ...
  settings: {
    ...
    uiThemeHint: 'Themes live in <config>/vue-panel/themes/<name>/ — missing components fall back to the default theme.',
    uiThemeIncompatible: 'requires Vue Panel {version}',
