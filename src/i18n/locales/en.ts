export default {
  ...
  editor: {
    ...
    cssAreas: {
      ...
      bottom_left: 'Bottom bar · left',
      bottom_center: 'Bottom bar · center',
      bottom_right: 'Bottom bar · right',
      bar_sidebar: 'Global sidebar',
    ...
    bottom: {
      title: 'Bottom bar',
      hint: 'The bottom bar has three slots — left, center and right. Add cards to each while editing.',
      height: 'Bar height (px)',
      heightHint: '40 to 240.',
    },
    barPlacement: {
  ...
  settings: {
    ...
    barPositionHints: {
      sidebar: 'On the left, visible from 1024 px',
